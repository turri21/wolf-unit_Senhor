...
module tb_pixblt_ll;
  ...
  initial begin : main
    ...
    // array — base + DY*PITCH — not last-pixel+1.
    //   SADDR = 0x800 + 2*0x80 = 0x900;  DADDR = 0x900 + 2*0x80 = 0xA00.
    check_breg("SADDR (B0) = 0x900 (base + DY*SPTCH, P0009)", 0, 32'h0000_0900);
    check_breg("DADDR (B2) = 0xA00 (base + DY*DPTCH, P0009)", 2, 32'h0000_0A00);
